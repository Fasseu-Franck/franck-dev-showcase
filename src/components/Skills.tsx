...
const Skills = () => {
  ...
  return (
    <section id="skills" className="py-20 md:py-32 bg-background relative overflow-hidden">
      {/* Ice Glow Effects */}
      <div className="absolute top-20 right-20 w-96 h-96 gradient-glow opacity-20 blur-3xl"></div>
      <div className="absolute bottom-20 left-20 w-80 h-80 gradient-glow opacity-15 blur-3xl"></div>
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            ...
            {/* Soft Skills */}
            <div className="glass-ice rounded-2xl p-6 md:p-8 hover:shadow-glow transition-all duration-300 animate-fade-in-up md:col-span-2 lg:col-span-1 liquid-border" style={{ animationDelay: "0.2s" }}>
              <div className="flex items-center gap-3 mb-6">
